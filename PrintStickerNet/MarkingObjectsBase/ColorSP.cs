...
namespace PrintSticker.MarkingObjectsBase {
    internal class ColorSP() {
        ...
        private static DateTime _dtLastEditFile = new(1929, 1, 1);//"DbColorSP.dbf"
        ...
        private void _LoadColors() {
            string strDestPath = "";
            if (!DbfWrapper.CheckIfFileExist("DbColorSP.dbf", ref strDestPath, ref _strSrcPathColor, "\\ooo\\"))
                return;
            int nCodeOut = -1;
